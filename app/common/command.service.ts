...
export class CommandService {
    ...
    newProject: CommandItem = new CommandItem('newProject', '新建项目', 'fa-file', 'Ctrl+N', '⌘+N', true, () => {this.projectService.newProject();});
    openProject: CommandItem = new CommandItem('openProject', '打开项目', 'fa-folder-open', 'Ctrl+O', '⌘+O', true, () => {this.projectService.openProject();});
